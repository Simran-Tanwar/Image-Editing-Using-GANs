...
class TrainOptions():
    ...
    def parse(self, print_opt=True):
        ...
        if opt.config_file:
            #print("Config file exists") # added for verification
            data = yaml.load(opt.config_file, Loader=yaml.FullLoader)
            data = self._flatten_to_toplevel(data)
        else:
            #print("Config file does not exist") # Added for verification
            data = {}
        ...
        #print(specified_options) # added for verfication
        ...
        #print("Opt attributes final")
        #print(dir(opt)) # added for verification
        #print(dir(opt.options)) # added for verification
        delattr(opt, 'config_file')
        #if opt.config_file: # added for verification
